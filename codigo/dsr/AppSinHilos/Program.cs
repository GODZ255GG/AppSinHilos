...
class Program
{
    public static void DoTrabajoPesado()
    {
        ...
        Thread.Sleep(1000);
        Console.WriteLine("DoTrabajoPesado: Cansao! Necesito una siesta de 3 seg.");
        Thread.Sleep(1000);
    ...
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("Presione cualquier tecla para termina...");
        Console.WriteLine("René Ulises García Velázquez: Desarrollo de Sistemas de Red");
